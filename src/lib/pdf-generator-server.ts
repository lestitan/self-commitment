// @ts-nocheck
// This is needed because jsPDF types don't match perfectly
...
// If in Node.js environment, we need to set up the document
if (isNode) {
...
// Server-side only: Gets PDF as buffer
export const getPDFBuffer = async (commitment: Partial<Contract>): Promise<Buffer> => {
